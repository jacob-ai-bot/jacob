...
- **Additional Notes**: [Any other relevant information.]`);
  ...
  return (
    ...
    >
      <div className="hide-scrollbar h-[calc(100vh-112px)] w-full flex-1 overflow-hidden overflow-y-scroll rounded-md bg-white/50 p-4 pb-8 shadow-sm dark:bg-slate-800 sm:max-w-5xl md:h-[calc(100vh-119px)]">
          ...
          <div className="flex w-full flex-col space-y-2 sm:w-auto sm:flex-row sm:space-x-2 sm:space-y-0">
            {!isEditing && createdTodoId && (
              <Link
                ...
                className="flex w-full items-center justify-center rounded-full bg-blossom-500 px-4 py-2 text-white transition-colors hover:bg-blossom-700 dark:bg-blossom-600 dark:hover:bg-blossom-500 sm:w-auto"
              >
                View Issue
              </Link>
            )}
        ...
        {isEditing ? (
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="mb-8 text-center text-xl font-bold text-gray-500 dark:text-gray-400 sm:text-2xl">
              Creating issue...
            </div>
            <LoadingIndicator />
          </div>
      ...
      {rewrittenIssue && (
        <div className="h-[calc(100vh-119px)] w-full overflow-hidden md:w-1/2">
